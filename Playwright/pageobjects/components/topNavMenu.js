class TopNavMenu {
  constructor(page) {
    ...
    this.titleFromTopNavMenuChild =
      "//div[@class='sublevel svelte-11jd0m6']/header[@class='svelte-10z05qh']/h5";
    this.titleFromTopNavMenuChildSecond =
      "//div[@class='sublevel svelte-13cos0r sublevel--first']/header[@class='svelte-10z05qh']/h5";
